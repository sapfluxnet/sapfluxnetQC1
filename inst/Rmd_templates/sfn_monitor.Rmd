...
fillRow(height = '100%', flex = 1,
  ggiraphOutput('si_elev_plot', width = "14%"),
  ggiraphOutput('st_age_plot', width = "14%"),
  ggiraphOutput('st_height_plot', width = "14%"),
  ggiraphOutput('st_density_plot', width = "14%"),
  ggiraphOutput('st_basal_area_plot', width = "14%"),
  ggiraphOutput('st_lai_plot', width = "14%"),
  ggiraphOutput('st_soil_depth_plot', width = "14%")
)
...
output$si_elev_plot <- renderggiraph({
  ...
  geom_boxplot_interactive(aes(data_id = Var, tooltip = Var),
  ...
  ggiraph(code = {print(si_elev_plot)},
          width = 0.95, width_svg = 6, height_svg = 5, zoom_max = 5,
          tooltip_extra_css = "background-color:black;font-style:italic;padding:10px;border-radius:10px 20px 10px 20px;color:white",
          hover_css = "fill-opacity:.4")
})
