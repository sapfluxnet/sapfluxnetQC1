...
Idea, botón para la función `update_sapfluxnetr_files`, que haría una copia nueva
de los main script, debug script, sfn monitor rmd, templates etc... para
ejecutarlo cada vez que se instale una nueva versión del paquete sapfluxnetr.
De esa manera los archivos pueden estar en el paquete y ser parte así del
repositorio.
