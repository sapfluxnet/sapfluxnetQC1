...
load_and_bind <- function(metadata) {
  ...
  if (metadata == 'site_md') {
    res <- lapply(object_list, get_site_md) %>% bind_rows
  }
  if (metadata == 'stand_md') {
    res <- lapply(object_list, get_stand_md) %>% bind_rows
  }
  if (metadata == 'species_md') {
    res <- lapply(object_list, get_species_md) %>% bind_rows
  }
  ...
  if (metadata == 'env_md') {
    res <- lapply(object_list, get_env_md) %>% bind_rows
  }
