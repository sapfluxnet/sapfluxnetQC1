            ...
            options = list(dom = 'tp',
                           columnDefs = list(list(className = 'dt-center',
                                             ...
                                             list(className = 'dt-right',
                                                  targets = 0)),
                           pageLength = 15,
                           scrollY = 350, fixedColumns = TRUE, scrollCollapse = TRUE)) %>%
  formatStyle('IsNA',
...
cowplot::ggdraw() +
  if(is.null(sapf_gaps_cal)) {cowplot::draw_plot(NULL, 0, .5, 1, .5)} else {
    cowplot::draw_plot(sapf_gaps_cal, 0, .5, 1, .5) 
  } +
  if(is.null(sapf_gaps_plot)) {cowplot::draw_plot(NULL, 0, .5, 1, .5)} else {
    cowplot::draw_plot(sapf_gaps_plot, 0, 0, .5, .5) 
  } +
  if(is.null(sapf_gaps_plot_int)) {cowplot::draw_plot(NULL, 0, .5, 1, .5)} else {
