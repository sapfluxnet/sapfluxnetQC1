...
<img src="qc_fix_timestamp.svg" alt="qc_fix_timestamp" style="width: 200px;"/>
...
<img src="qc_outliers_process.svg" alt="qc_outliers_process" style="width: 750px;"/>
...
<img src="qc_out_hampel_filter.svg" alt="qc_out_hampel_filter" style="width: 500px;"/>

## `qc_out_median`

Classic Hampel filter

<img src="qc_out_median.svg" alt="qc_out_median" style="width: 350px;"/>

## `qc_out_medianreg`

Hampel filter with median regression

<img src="qc_out_medianreg.svg" alt="qc_out_medianreg" style="width: 350px;"/>

## `qc_out_of_range`

Checking data for out of range values, updating the corresponding data flags

<img src="qc_out_of_range.svg" alt="qc_out_of_range" style="width: 500px;"/>

## `qc_out_remove`

Outliers detection, substitution and annotation for SfnData objects

<img src="qc_out_remove.svg" alt="qc_out_remove" style="width: 400px;"/>

## `qc_out_tukeyline`

Hampel filter with robust fitting

<img src="qc_out_tukeyline.svg" alt="qc_out_tukeyline" style="width: 350px;"/>
...
<img src="qc_rad_conversion.svg" alt="qc_rad_conversion" style="width: 250px;"/>

## `qc_range_dic`

Dictionary with range values for all ranges checked

<img src="qc_range_dic.svg" alt="qc_range_dic" style="width: 250px;"/>

## `qc_rh`

Calculate the relative humidity from air temperature and vpd

<img src="qc_rh.svg" alt="qc_rh" style="width: 250px;"/>

## `qc_sapf_ranges`

Check ranges for sapflow

<img src="qc_sapf_ranges.svg" alt="qc_sapf_ranges" style="width: 650px;"/>
...
<img src="qc_soil_texture.svg" alt="qc_soil_texture" style="width: 650px;"/>
...
<img src="qc_swc_check.svg" alt="qc_swc_check" style="width: 200px;"/>

## `qc_swc_fix`

Fix the swc values if possible

<img src="qc_swc_fix.svg" alt="qc_swc_fix" style="width: 200px;"/>
...
<img src="qc_timestamp_nas.svg" alt="qc_timestamp_nas" style="width: 200px;"/>
...
<img src="qc_transformation_vars.svg" alt="qc_transformation_vars" style="width: 500px;"/>

## `qc_transf_list`

Show all transformations indicating which ones can be done

<img src="qc_transf_list.svg" alt="qc_transf_list" style="width: 600px;"/>

## `qc_units_process`

Checking for available transformations and perform them if needed.

<img src="qc_units_process.svg" alt="qc_units_process" style="width: 750px;"/>

## `qc_vpd`

Calculates the vpd if needed and possible from other environmental variables

<img src="qc_vpd.svg" alt="qc_vpd" style="width: 250px;"/>
...
<img src="vis_biome.svg" alt="vis_biome" style="width: 450px;"/>
...
<img src="vis_location_biome.svg" alt="vis_location_biome" style="width: 400px;"/>
...
<img src="symbols_legend.svg" alt="symbols_legend" style="width: 250px;"/>
